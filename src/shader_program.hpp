...
namespace sve 
{
	...
	public:
		...
		void bind(vk::CommandBuffer command_buffer, glm::ivec2 framebuffer_size) const;
	...
	private:
		static void set_viewport_scissor(vk::CommandBuffer command_buffer, glm::ivec2 framebuffer_size);
